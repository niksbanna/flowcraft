    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Visual workflow automation platform</p>
        </div>
          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsContent value="login" className="mt-0">
                {loginError && (
                  <Alert variant="destructive" className="mb-4 bg-red-950/30 border-red-800 text-red-300">
          ...
          <CardFooter className="flex flex-col space-y-4 mt-4">
            <div className="relative w-full">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-gray-950 px-2 text-muted-foreground">Or continue with</span>
              </div>
            </div>
